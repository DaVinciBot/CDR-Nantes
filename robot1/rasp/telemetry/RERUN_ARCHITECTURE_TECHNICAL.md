...
Called by: Polling via vision.localization.get_latest_scan_data()
Thread-safe: Yes
Parameters:
...
Called by: Polling via vision.localization.get_latest_beacon_candidates()
Thread-safe: Yes
Parameters:
  cands: List of dicts
...
Called by: Polling via vision.localization.get_corrected_pose()
Thread-safe: Yes
Parameters:
  x:    Position X in mm
  y:    Position Y in mm
